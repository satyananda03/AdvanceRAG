...
def create_app(args):
    ...
    # Expose the initialized LightRAG instance so an outer composition layer
    # (e.g. app.api.main) can wrap a shared RAGAnything around the SAME
    # instance instead of building a second, divergently-configured one.
    app.state.rag = rag
